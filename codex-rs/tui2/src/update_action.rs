...
pub enum UpdateAction {
    /// Update via `npm install -g @azure/codex@latest`.
    NpmGlobalLatest,
    /// Update via `bun install -g @azure/codex@latest`.
    BunGlobalLatest,
    /// Update via `brew upgrade azure-codex`.
    BrewUpgrade,
}
...
impl UpdateAction {
    ...
    pub fn command_args(self) -> (&'static str, &'static [&'static str]) {
        match self {
            UpdateAction::NpmGlobalLatest => ("npm", &["install", "-g", "@azure/codex"]),
            UpdateAction::BunGlobalLatest => ("bun", &["install", "-g", "@azure/codex"]),
            UpdateAction::BrewUpgrade => ("brew", &["upgrade", "azure-codex"]),
        }
    }
