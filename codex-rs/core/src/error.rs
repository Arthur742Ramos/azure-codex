...
pub enum CodexErr {
    ...
    #[error("Usage not included in your current plan. Check your subscription or API quota.")]
    UsageNotIncluded,
    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let message = match self.plan_type.as_ref() {
            Some(PlanType::Known(KnownPlan::Plus)) => format!(
                "You've hit your usage limit. Consider upgrading your plan or check your quota settings{}",
            ...
            Some(PlanType::Known(KnownPlan::Free)) => {
                "You've hit your usage limit. Consider upgrading your plan to continue.".to_string()
            }
            Some(PlanType::Known(KnownPlan::Pro)) => format!(
                "You've hit your usage limit. Check your quota settings{}",
                retry_suffix_after_or(self.resets_at.as_ref())
            ),
...
mod tests {
    ...
    fn usage_limit_reached_error_formats_plus_plan() {
        ...
        assert_eq!(
            err.to_string(),
            "You've hit your usage limit. Consider upgrading your plan or check your quota settings or try again later."
        );
    }
    ...
    fn usage_limit_reached_error_formats_free_plan() {
        ...
        assert_eq!(
            err.to_string(),
            "You've hit your usage limit. Consider upgrading your plan to continue."
        );
    }
    ...
    fn usage_limit_reached_error_formats_pro_plan_with_reset() {
        ...
        with_now_override(base, move || {
            ...
            let expected = format!(
                "You've hit your usage limit. Check your quota settings or try again at {expected_time}."
            );
            assert_eq!(err.to_string(), expected);
        });
    }
    ...
    fn usage_limit_reached_includes_hours_and_minutes() {
        ...
        with_now_override(base, move || {
            ...
            let expected = format!(
                "You've hit your usage limit. Consider upgrading your plan or check your quota settings or try again at {expected_time}."
            );
            assert_eq!(err.to_string(), expected);
        });
    }
