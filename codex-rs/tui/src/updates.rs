...
const HOMEBREW_CASK_URL: &str =
    "https://raw.githubusercontent.com/Homebrew/homebrew-cask/HEAD/Casks/a/azure-codex.rb";
const LATEST_RELEASE_URL: &str =
    "https://api.github.com/repos/Arthur742Ramos/azure-codex/releases/latest";
